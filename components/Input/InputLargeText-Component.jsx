...
export default function InputLargeText({title, setResult}){
  ...
  return(
    <div className="">
      ...
      <div className="flex border border-gray-400 rounded hover:border-blue-400 focus:border-transparent focus:ring-2 focus:ring-blue-300 outline-none">
        <textarea value={value} onChange={(e)=>atChangeValue(e?.target?.value)} className="text-gray-800 px-2 py-2 text-sm flex-1 outline-none rounded-l focus:border-transparent focus:ring-2 focus:ring-blue-300" />        
      </div>

...
function FooterComponent() {
  ...
  const handlerSubscirbe = async () => {    
    await alertSuccess("Terima kasih", "Nantikan informasi dan berita terbaru dari Gadai Syariah Indonesia")
    setEmail("")
  }
  ...
  return (
    ...
    <div className="bg-white inset-x-0 bottom-0 md:pt-10 w-full border-t md:mt-10 border-gray-100">
      <div className="md:space-y-10 md:space-y-0 md:flex lg:space-x-10">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 space-y-5">
          ...
          <p className="text-gray-600 font-light">
            Dapatkan informasi, berita dan penawaran terbaru dari LMan
          </p>
      ...
      <div className="flex justify-between mb-5">
        <div className="">
          <p className="text-gray-500 font-light text-xs">2021 LMan. All rights reserved</p>
        </div>        
